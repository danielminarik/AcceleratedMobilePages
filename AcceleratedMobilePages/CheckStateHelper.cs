...
namespace AcceleratedMobilePages.AcceleratedMobilePages
{
    public static class CheckStateHelper
    {
        ...
        public static int CheckFilterState()
        {
            ...
            if (CMS.PortalEngine.PortalContext.ViewMode != ViewModeEnum.LiveSite && CMS.PortalEngine.PortalContext.ViewMode != ViewModeEnum.Preview)
            {
                return Constants.DISABLED;
            }
            ...
            string currentDomain = CMS.Helpers.CMSHttpContext.Current.Request.Url.IsDefaultPort ? CMS.Helpers.CMSHttpContext.Current.Request.Url.Host : CMS.Helpers.CMSHttpContext.Current.Request.Url.Host + ":" + CMS.Helpers.CMSHttpContext.Current.Request.Url.Port;
